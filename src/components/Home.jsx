...
export default function Home(props) {
    ...
    return (
        <section className="h-screen w-screen bg-primary-light relative z-0 pt-20 px-5 md:px-20 items-center  flex">
            <img className='absolute -z-1 pointer-events-none right-0 top-0' src={effectbg} alt="effect" />
            <div className='w-full md:w-1/2 flex flex-col gap-3 text-dark  z-0'>
